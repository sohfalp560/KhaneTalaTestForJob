...
class Transaction(models.Model):
    ...
    type = models.CharField(max_length=1,choices=TypeOfTX,null=False,blank=False,)
    amount_rial = models.PositiveIntegerField(null=False,blank=False,)
    gold_weight_gram = models.DecimalField(max_digits=9,decimal_places=3,null=False,blank=False,)
    price_per_gram = models.PositiveIntegerField(null=False,blank=False,)
